...
pub const SOURCES: &[SeedSource] = &[
    ...
    // Dedicated discovery lanes prevent the broad headline feed from being
    // the only way a finance or overseas-Chinese story can reach the desk.
    // They are Google News result feeds, so we retain the original publisher
    // attribution and link; the newsroom never republishes their full text.
    SeedSource {
        slug: "gnews-zh-finance-live",
        name: "Google 新闻 · 财经金融焦点",
        kind: SourceKind::Rss,
        url: "https://news.google.com/rss/search?q=%28%E7%BE%8E%E8%81%94%E5%82%A8+OR+%E7%BE%8E%E8%82%A1+OR+%E6%B8%AF%E8%82%A1+OR+%E9%BB%84%E9%87%91+OR+%E6%B1%87%E7%8E%87+OR+%E5%80%BA%E5%88%B8+OR+%E6%88%BF%E5%9C%B0%E4%BA%A7%29+when%3A1d&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        homepage: "https://news.google.com",
        trust: 70,
        poll_interval_s: 120,
        beat: Some(Beat::Markets),
    ...
    SeedSource {
        slug: "gnews-zh-macro-trade",
        name: "Google 新闻 · 宏观与贸易",
        kind: SourceKind::Rss,
        url: "https://news.google.com/rss/search?q=%28%E5%85%B3%E7%A8%8E+OR+%E8%B4%B8%E6%98%93+OR+%E9%80%9A%E8%83%80+OR+%E5%B0%B1%E4%B8%9A+OR+GDP+OR+%E5%A4%AE%E8%A1%8C%29+when%3A1d&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        homepage: "https://news.google.com",
        trust: 70,
        poll_interval_s: 120,
        beat: Some(Beat::Markets),
    ...
    SeedSource {
        slug: "gnews-zh-global-focus",
        name: "Google 新闻 · 全球焦点",
        kind: SourceKind::Rss,
        url: "https://news.google.com/rss/search?q=%28%E6%88%98%E4%BA%89+OR+%E9%80%89%E4%B8%BE+OR+%E5%A4%96%E4%BA%A4+OR+%E5%88%B6%E8%A3%81+OR+%E8%83%BD%E6%BA%90+OR+%E9%9C%B8%E6%9D%83%29+when%3A1d&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        homepage: "https://news.google.com",
        trust: 68,
        poll_interval_s: 120,
        beat: Some(Beat::World),
    ...
    SeedSource {
        slug: "gnews-zh-creaders",
        name: "Google 新闻 · 万维读者网线索",
        kind: SourceKind::Rss,
        url: "https://news.google.com/rss/search?q=site%3Acreaders.net+when%3A2d&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        homepage: "https://news.google.com",
        trust: 56,
        poll_interval_s: 300,
        beat: Some(Beat::World),
    ...
    SeedSource {
        slug: "gnews-zh-wenxuecity",
        name: "Google 新闻 · 文学城线索",
        kind: SourceKind::Rss,
        url: "https://news.google.com/rss/search?q=site%3Awenxuecity.com+when%3A2d&hl=zh-CN&gl=CN&ceid=CN:zh-Hans",
        homepage: "https://news.google.com",
        trust: 56,
        poll_interval_s: 300,
        beat: Some(Beat::World),
